...
const SmallDataAnalysis = () => {
    ...
    return (
        <div className="container mx-auto" style={{ overflowX: 'hidden', overflowY: 'auto' }}>
...
export default SmallDataAnalysis;
