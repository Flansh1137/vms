...
const DataAnalysis = lazy(() => import('./BigdataAnalysis')); // Adjust the import based on your project structure
  ...
  return (
    <div className="flex justify-center items-center min-h-screen bg-gray-100">
      ...
      <div className="flex flex-col lg:flex-row w-full justify-between px-6">
        ...
        <div className="w-full lg:w-[35%] h-screen p-4 bg-white shadow-md rounded-lg overflow-y-auto mb-6 lg:mb-0">
