...
// import registrationImage from '../../../assets/registration.jpg'; // Import the background image
...
//                         style={{ fontFamily: 'Arial, sans-serif', color: 'white' }} // Set text color to white
//                     >
